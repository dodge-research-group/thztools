...
def epswater(f, t=25):
    ...
    p = np.array([-0.006118594, -0.000012936798, 4235901000000, -14260880000,
                  273815700, -1246943, 9.618642e-14, 1.795786e-16,
                  -9.310017e-18, 1.655473e-19, 0.6165532, 0.007238532,
                  -0.00009523366, 15983170000000, -74413570000, 497448000,
                  2.882476e-14, -3.142118e-16, 3.528051e-18])
    ...
    # Put it all together
    epsilonr = (eps0 + 2 * 1j * np.pi * f
                * (delta[0] * tau[0] /
                   (1 - 2 * 1j * np.pi * f * tau[0])
